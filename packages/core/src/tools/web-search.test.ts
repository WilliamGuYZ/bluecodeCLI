        ...
        candidates: [
          {
            ...
            groundingMetadata: {
              groundingChunks: [
                ...
                {
                  web: {
                    title: 'google-gemini/bluecode-cli',
                    uri: 'https://github.com/google-gemini/bluecode-cli',
                  },
                },
                {
                  web: {
                    title: 'Gemini CLI: your open-source AI agent',
                    uri: 'https://blog.google/technology/developers/introducing-bluecode-cli-open-source-ai-agent/',
                  },
                },
              ],
              groundingSupports: [
...
[2] google-gemini/bluecode-cli (https://github.com/google-gemini/bluecode-cli)
[3] Gemini CLI: your open-source AI agent (https://blog.google/technology/developers/introducing-bluecode-cli-open-source-ai-agent/)`;

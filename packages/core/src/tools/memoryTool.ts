...
import { ToolEditConfirmationDetails, ToolResult } from './tools.js';
import {
  BaseDeclarativeTool,
  BaseToolInvocation,
  Kind,
...
export const GEMINI_CONFIG_DIR = '.bluecode-cli';
export const DEFAULT_CONTEXT_FILENAME = 'AGENTS.md'; // 没有settings.json没有contextFileName字段就默认读取这个
export const MEMORY_SECTION_HEADER = '## BlueCode CLI Added Memories';

...
import type { DetectedIde } from '@vivo/bluecode-cli-core';
import { getIdeInfo } from '@vivo/bluecode-cli-core';
    ...
    >
      <Box marginBottom={1} flexDirection="column">
        <Text>
          ...
          {`Do you want to connect ${ideName ?? 'your editor'} to BlueCode CLI?`}
        </Text>

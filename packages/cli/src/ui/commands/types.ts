...
import type { Config, GitService, Logger } from '@vivo/bluecode-cli-core';
...
export interface CommandContext {
  ...
  ui: {
    ...
    clear: () => void;
    /** Returns the current buffered console messages shown in the debug console. */
 ...
 *
 * 这个接口定义了"打开对话框"动作的返回类型
 * 当命令需要显示一个对话框时，会返回这种类型的对象
 */

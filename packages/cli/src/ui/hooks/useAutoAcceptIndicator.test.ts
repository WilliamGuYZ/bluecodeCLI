...
import type { Config as ActualConfigType } from '@vivo/bluecode-cli-core';
import { Config, ApprovalMode } from '@vivo/bluecode-cli-core';
...
vi.mock('@vivo/bluecode-cli-core', async () => {

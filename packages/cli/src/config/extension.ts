...
import { Storage } from '@vivo/bluecode-cli-core';
...
export const EXTENSIONS_DIRECTORY_NAME = '.bluecode/extensions';

export const EXTENSIONS_CONFIG_FILENAME = 'bluecode-extension.json';
export const INSTALL_METADATA_FILENAME = '.bluecode-extension-install.json';
...
export async function installExtension(
  ...
  try {
    ...
    // ~/.bluecode-cli/extensions/{ExtensionConfig.name}.

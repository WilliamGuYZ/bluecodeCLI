  ...
  general: {
    ...
    properties: {
      ...
      sessionRetention: {
        ...
        description: 'Settings for automatic session cleanup and retention.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
          ...
          minRetention: {
            ...
            default: '1d',
            description:
              'Minimum retention time before deletion (e.g., "1d").',
            showInDialog: false,
          },
        },
      },
  ...
  model: {
    ...
    properties: {
      name: {
        ...
        requiresRestart: false,
        default: undefined as string | undefined,
        description: 'The BlueCode model to use for conversations.',
        showInDialog: false,
      },
      maxSessionTurns: {
        type: 'number',
